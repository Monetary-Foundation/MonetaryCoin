...
contract('MCoinDistributionMock', function (accounts) {
  ...
  // it('should commitOn() successfully and add a commitment', async function () {
  //   await increaseTimeTo(windowTimeStamp(startTime, 0));
  ...
  //   const commitment = await distribution.commitment(window, buyer);
  ...
  //   describe('when trying to commit', function () {
  //     beforeEach(async function () {
