 ...
 * @dev MUSA
 */
contract MUSA is MinableM5Token, ComplianceStore {

  string public constant name = "US"; // solium-disable-line uppercase
  string public constant symbol = "US"; // solium-disable-line uppercase
